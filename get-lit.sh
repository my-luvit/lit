...
_lit_url="https://lit.bilal0.dev/packages/my-luvit/lit/${LIT_VERSION}.zip"
_luvit_url="https://lit.bilal0.dev/packages/my-luvit/luvit/${LUVIT_VERSION}.zip"
...
if [ "${LUVI_VERSION}" = "latest" ]; then # select the latest endpoint
    ...
    _luvi_url="https://github.com/my-luvit/luvi/releases/download/${LUVI_VERSION}/luvi-${LUVI_OS}-${LUVI_ARCH}-${LUVI_ENGINE}-${LUVI_FLAVOR}"
fi
