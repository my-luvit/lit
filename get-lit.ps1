...
if (${LUVI_VERSION} -eq "latest") {
  $luvi_url = "https://github.com/my-luvit/luvi/releases/latest/download/luvi-${LUVI_OS}-${LUVI_ARCH}-${LUVI_ENGINE}-${LUVI_FLAVOR}${exe_suffix}"
}
elseif (VersionGTE $LUVI_VERSION "2.15.0") {
  $luvi_url = "https://github.com/my-luvit/luvi/releases/download/${LUVI_VERSION}/luvi-${LUVI_OS}-${LUVI_ARCH}-${LUVI_ENGINE}-${LUVI_FLAVOR}${exe_suffix}"
}
else {
  $luvi_url = "https://github.com/my-luvit/luvi/releases/download/${LUVI_VERSION}/luvi-${LUVI_FLAVOR}-${LUVI_OS}_${LUVI_ARCH}${exe_suffix}"
}
$lit_url = "https://lit.bilal0.dev/packages/my-luvit/lit/${LIT_VERSION}.zip"
$luvit_url = "https://lit.bilal0.dev/packages/my-luvit/luvit/${LUVIT_VERSION}.zip"
